...
| Rule                                                                                                                                                                                                                                                                       | Action                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| NSFW Content<br>This is when a user posts gore (humans or other animals) or explicit/borderline sexual content. Non-graphic pictures of dead animals may be shared only with a spoiler. For good-faith hunting imagery sent without a spoiler, simply delete and give an informal warning. | Mute (4 days)<br>Manually delete the offending messages |
